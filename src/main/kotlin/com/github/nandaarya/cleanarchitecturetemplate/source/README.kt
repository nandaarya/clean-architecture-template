...
### 4. **Masalah Retrofit: "Http and https not found"**
   - Jika Anda memilih untuk menggunakan fitur **Retrofit** saat membuat proyek baru, Anda mungkin akan menemukan error berikut saat pertama kali menjalankan aplikasi:
     ...
     ```
   - **Ini adalah error yang wajar** dan terjadi karena **URL base** untuk Retrofit belum diatur. Untuk mengatasi masalah ini, ikuti langkah-langkah berikut:
     ...
     2. **Atur base URL** sesuai dengan API endpoint yang Anda gunakan.
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        ```
     3. Setelah mengatur base URL, pastikan untuk **menyesuaikan file-file lainnya** seperti `ApiService.kt` dan **endpoint** yang Anda gunakan dalam aplikasi Anda.
